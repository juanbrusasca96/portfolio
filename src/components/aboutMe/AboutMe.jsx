                        ...
                        <AnimationOnScroll offset={0} animateOnce={true} animateIn="animate__fadeInLeftBig">
                            ...
                            <div class="container">
                                ...
                                <div class="terminal_toolbar">
                                    ...
                                    <p class="user">juanbrusasca@admin: ~</p>
                                </div>
                                <div class="terminal_body">
                                    <div class="terminal_promt">
                                        <span class="terminal_user">juanbrusasca@admin:</span>
                                        <span class="terminal_location">~</span>
                                        <span class="terminal_bling">$ Soy desarrollador fullstack. Soy un apasionado de la programación y de la lógica. Disfruto estar sentado programando, incluso durante largas horas cuando me trabo con algo. Y ni hablar de la hermosa sensación que me genera cuando ese programa sale andando como quiero. Soy un fiel creyente del trabajo duro, la perseverancia y el nunca rendirse, y considero que esto se complementa bien con mi gusto por programar. Soy estudiante de Licenciatura en Ciencias de la Computación en la Universidad Nacional de Córdoba. <span class="terminal_cursor"></span></span>
