                            ...
                            <div className="container">
                                ...
                                <div className="terminal_body">
                                    <div className="terminal_promt">
                                        ...
                                        <span className="terminal_bling">{spanish ? '$ Full Stack Developer con formación como Diseñador Web. Con pensamiento creativo, resolución de problemas, trabajo en equipo, comunicación y autonomía. Soy un apasionado de la programación y de la lógica. Soy un fiel creyente del trabajo duro y el nunca rendirse, y considero que esto se complementa bien con mi gusto por programar.' : "$ Full Stack Developer with a background as a Web Designer. With creative thinking, problem solving, teamwork, communication and autonomy. I am passionate about programming and logic. I am a believer in hard work and never giving up, and I think this complements well with my love for programming."}<span className="terminal_cursor"></span></span>
                                    </div>
                                </div>
                            </div>
                        </AnimationOnScroll>
                ...
                <Grid item container justifyContent="center" alignItems="center" xs={12}>
                    <Grid item container justifyContent="center" alignItems="center" className='download'>
                        <AnimationOnScroll offset={0} delay={800} animateOnce={true} animateIn="animate__fadeInRightBig">
                            <button> <a href={spanish ? require(`../../files/CV-JuanBrusasca.pdf`) : require(`../../files/CVJuanBrusasca.pdf`)} download={spanish ? 'CV - Brusasca Juan (ES)' : 'CV - Brusasca Juan (EN)'}>{spanish ? 'DESCARGAR CV' : 'DOWNLOAD CV'}</a>
                            </button>
                        </AnimationOnScroll>
                    </Grid>
